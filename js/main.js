...
const productsData = {
  ...
  projectsPlaceholder2: {
    ...
    description: "Now the html5 programs and games will begin to include mobile browser support. Programs will have mobile browser compatibility in the desktop versions. Programs created for browser compatibility will be found here: List-Melodicaine-ready, Portfolio- ready, SanityVideo- ready, VizShow- ready, NeutralNote- Beta ready, StickyMesh- ready Note Knower-Beta ready.",
